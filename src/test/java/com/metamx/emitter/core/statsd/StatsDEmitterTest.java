...
public class StatsDEmitterTest
{
  ...
  public void testConvertRange()
  {
    ...
    emitter.emit(new ServiceMetricEvent.Builder()
                     ...
                     .build(DateTime.now(DateTimeZone.UTC), "query/cache/total/hitRate", 0.54)
  ...
  public void testNoConvertRange()
  {
    ...
    emitter.emit(new ServiceMetricEvent.Builder()
                     ...
                     .build(DateTime.now(DateTimeZone.UTC), "query/time", 10)
                     .build("broker", "brokerHost1")
    );
    EasyMock.verify(client);
  }
  ...
  public void testBlankHolderOptions()
  {
    ...
    emitter.emit(new ServiceMetricEvent.Builder()
                     ...
                     .build(DateTime.now(DateTimeZone.UTC), "jvm/gc/count", 1)
                     .build("broker", "brokerHost1")
    );
    EasyMock.verify(client);
  }
  ...
  public void testServiceAsTagOption()
  {
    ...
    client.time("default.query.time", 10,
            "component:druid/broker", "dataSource:data-source", "type:groupBy", "hostname:brokerHost1"
    );
    EasyMock.replay(client);
    emitter.emit(new ServiceMetricEvent.Builder()
            .setDimension("dataSource", "data-source")
  ...
  public void testAlertEvent()
  {
    ...
    client.recordEvent(
        ...
        EasyMock.eq("feed:alerts"), EasyMock.eq("component:druid/broker"),
